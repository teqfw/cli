...
type TeqFw_Cli_Manifest_Command = Readonly<{id: string; path: ReadonlyArray<string>; summary: string; arguments: ReadonlyArray<TeqFw_Cli_Manifest_Argument>; options: ReadonlyArray<TeqFw_Cli_Manifest_Option>; component: string}>;
...
type TeqFw_Cli_Launch_Context = Readonly<{argv: ReadonlyArray<string>; cwd: string; applicationRoot: string; version: string}>;
