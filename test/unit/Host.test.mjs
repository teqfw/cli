...
function createHost() {
    ...
    const parser = {select: () => ({kind: 'command', command: descriptor, args: Object.freeze({}), options: Object.freeze({})})};
    return {host: new Host({parser, signals, io}), signal: (name) => listener(name)};
}
