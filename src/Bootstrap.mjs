        ...
        this.start = async function (launch, resolve) {
            ...
            for (const record of packages) {
                ...
                if (Object.hasOwn(cli, 'lifecycle')) {
                    ...
                    throw new Error(`Package '${packageName}' declares retired 'teqfw.fw.cli.lifecycle'. Replace 'lifecycle: ["Example_Cli_Plugin$"]' with 'plugin: "Example_Cli_Plugin$"'; implement only 'onStartup()' and 'onShutdown()', and remove 'initialize', 'activate', 'deactivate', and 'dispose'.`);
                }
