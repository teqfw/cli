...
12. The CLI runtime depends on cfg and calls TeqFw_Cfg_Loader.load() exactly once, with host-declared ordered Sources or an empty list, before resolving Bootstrap, plugins, or commands.
